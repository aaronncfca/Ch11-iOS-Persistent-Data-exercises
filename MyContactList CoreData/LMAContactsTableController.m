...
{
    [super viewDidLoad];
    sortOrderItems = @[@"contactName", @"city", @"birthday", @"zipCode", @"phoneNumber", @"cellNumber", @"email"];
...
- (void) loadDataFromDatabase
{
    ...
    int sortFieldInt = [settings integerForKey:kSortField];
    //Retrieve correct string property based on index.
    NSString * sortField = sortOrderItems[sortFieldInt];
